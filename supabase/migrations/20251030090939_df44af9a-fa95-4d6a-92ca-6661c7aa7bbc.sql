...
BEGIN
  ...
  VALUES (
    ...
    NEW.home_team_score - NEW.away_team_score, v_home_points
  )
  ...
  VALUES (
    ...
    NEW.away_team_score - NEW.home_team_score, v_away_points
  )
  ON CONFLICT (season_id, team_id) DO UPDATE SET
    played = standings.played + 1,
...
DROP TRIGGER IF EXISTS on_match_result_change ON public.match_results;
